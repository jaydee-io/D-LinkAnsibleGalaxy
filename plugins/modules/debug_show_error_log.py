...
DOCUMENTATION = r"""
---
module: debug_show_error_log
short_description: Display error log on a D-Link DGS-1250 switch
description:
  - Executes the C(debug show error-log) CLI command on a D-Link DGS-1250 switch.
  - Displays the error log information.
  - Corresponds to CLI command described in chapter 13-4 of the DGS-1250 CLI Reference Guide.
version_added: "0.8.0"
author:
  - Jérôme Dumesnil
options: {}
...
- name: Display error log
  jaydee_io.dlink_dgs1250.debug_show_error_log:
  register: error_log
"""
