...
def main():
    ...
    commands = _build_commands(module.params["address"], module.params["severity"], module.params["facility"],
                               module.params["discriminator"], module.params["port"], module.params["state"])
