...
def main():
    ...
    commands = _build_commands(module.params["name"], module.params["facility_match"], module.params["facility_string"], module.params["severity_match"], module.params["severity_list"], module.params["state"])
