...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            state=dict(type="str", choices=["enabled", "disabled", "default"], default="enabled"),
        ),
        supports_check_mode=True,
    )
    commands = _build_commands(module.params["severity"], module.params["discriminator"], module.params["write_delay"], module.params["state"])
