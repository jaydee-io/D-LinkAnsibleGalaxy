...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            speed=dict(type="str", choices=["10", "100", "1000", "10giga", "auto"]),
    ...
    commands = _build_commands(module.params["interface"], module.params["speed"], module.params["master_slave"], module.params["speed_list"], module.params["state"])
