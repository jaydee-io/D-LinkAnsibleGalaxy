...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            state=dict(type="str", choices=["enabled", "disabled", "threshold_absent"], default="enabled"),
        ),
        supports_check_mode=True,
    )
    commands = _build_commands(module.params["rising_threshold"], module.params["falling_threshold"], module.params["state"])
