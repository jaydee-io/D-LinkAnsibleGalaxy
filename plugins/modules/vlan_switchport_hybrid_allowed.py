...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            action=dict(type="str", choices=["add", "remove", "set"], default="add"),
    ...
    commands = _build_commands(module.params["interface"], module.params["action"], module.params["tagging"], module.params["vlan_id"], module.params["state"])
