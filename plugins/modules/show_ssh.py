...
---
module: show_ssh
short_description: Display SSH server connections on a D-Link DGS-1250 switch
description:
  - Executes the C(show ssh) CLI command on a D-Link DGS-1250 switch.
  - Displays the status of SSH server connections.
  - Corresponds to CLI command described in chapter 58-8 of the DGS-1250 CLI Reference Guide.
...
- name: Show SSH connections
  jaydee_io.dlink_dgs1250.show_ssh:
"""
