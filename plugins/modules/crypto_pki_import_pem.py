...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            import_type=dict(type="str", required=True, choices=["ca", "local", "both"]),
        ),
        supports_check_mode=True,
    )
    commands = _build_commands(module.params["trustpoint"], module.params["source"], module.params["password"], module.params["import_type"])
