...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            frame_type=dict(type="str", choices=["tagged-only", "untagged-only", "admit-all"]),
            state=dict(type="str", choices=["present", "absent"], default="present"),
        ),
        supports_check_mode=True,
    )
    commands = _build_commands(module.params["interface"], module.params["frame_type"], module.params["state"])
